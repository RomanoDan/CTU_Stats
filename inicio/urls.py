...
from inicio.views import inicio, lista_jugadores,lista_jugadores_general,reglamento,info_general,detalle_jugador,detalle_jugador_general,importar_participacion_json,detalle_partida
